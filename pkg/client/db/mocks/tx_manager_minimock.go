...
//go:generate minimock -i github.com/vl-usp/water_bot/pkg/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/vl-usp/water_bot/pkg/client/db"
)
